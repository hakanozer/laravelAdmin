...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12" style="margin-bottom: 20px">
			<!-- /.col-lg-12 -->
			<a href="{{url ('admin/urunEkle')}}" class="btn btn-primary">Ürün Ekle</a>
			<a href="{{url ('admin/kategoriler')}}" class="btn btn-primary">Kategoriler</a>
		</div>
	</div>
	<!-- /.row -->
	<div class="row">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="dataTable_wrapper">
							...
							<tbody>
							 @if(isset($veri)) @foreach( $veri as $urun)
							<tr class="odd gradeX">
								<td>
									{{ $urun->id }}
								</td>
